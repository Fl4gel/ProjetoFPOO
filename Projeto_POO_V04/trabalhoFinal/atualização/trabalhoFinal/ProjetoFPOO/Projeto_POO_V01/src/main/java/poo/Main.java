...
public class Main {
    ...
    public static void cadastrarMusica(Scanner teclado){
        ...
        System.out.println("\nQual a classificação da música?\n");
        Classificacao = teclado.nextLine();
        

        System.out.println("\nQual a categoria da música?\n");
        Categoria = teclado.nextLine();
        ...
        Musica musica = new Musica(Duracao, Titulo, Classificacao, Categoria, Artista);
    ...
    public static void cadastrarSerie(Scanner teclado){
        ...
        Serie serie = new Serie(Duracao, Titulo, Classificacao, Categoria, Temporada, Episodio);
        ...
        if(serieEncontrado != null){
            ...
            switch (atributo){
                case 1://Duracao
                    ...
                    //recolhe variável
                    System.out.println("\nQual a nova duração da série?\n");
                    Duracao = teclado.nextInt();
                    teclado.nextLine();

                    serieEncontrado.setDuracao(Duracao);
        ...
        if(musicaEncontrado != null){
            ...
            switch (atributo){
                ...
                case 3://Classificacao
                    ...
                    //recolhe variável
                    System.out.println("\nQual a nova classificação da música?\n");
                    Classificacao = teclado.nextLine();

                    musicaEncontrado.setClassificacao(Classificacao);
                break;
                ...
                case 4://Categoria
                    ...
                    //recolhe variável
                    System.out.println("\nQual a nova categoria da música?\n");
                    Categoria = teclado.nextLine();

                    musicaEncontrado.setCategoria(Categoria);
                break;
                case 5://Artista
                    //cria variável
                    String Artista; 
    ...
    public static void excluirFilme(Scanner teclado){
        ...
        if(filmeEncontrado != null){
            ...
            if(certeza == 1){
                ...
                System.out.println("\nOperação canclada voltando para o menu..\n");
            }
